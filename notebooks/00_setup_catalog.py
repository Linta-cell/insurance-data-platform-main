...
# MAGIC The catalog `insurance_catalog_linta` must be created via the Databricks UI BEFORE
...
# will automatically use insurance_catalog_linta.bronze, insurance_catalog_linta.silver, etc.
...
# MAGIC CREATE VOLUME IF NOT EXISTS insurance_catalog_linta.bronze.raw_data
# MAGIC COMMENT 'Raw landing-zone files for synthetic and public source data';

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE VOLUME IF NOT EXISTS insurance_catalog_linta.bronze.checkpoints
...
# MAGIC SHOW SCHEMAS IN insurance_catalog_linta;
